...
function compatPlugin(pluginOpts) {
    ...
    var filter = pluginutils_1.createFilter(include, exclude);
    var config = {
    ...
    return {
        ...
        transform: function (src, id) {
            ...
            var _a = core_1.transform(src, __assign(__assign(__assign({}, DEFAULT_BABEL_CONFIG), config), { presets: [[es5_proxy_compat_1.babelPreset, {
