...
function default_1(root) {
    root.nodes.forEach((selector) => {
        selector.nodes.forEach((node) => {
            ...
            const shouldInsertSpace = selector.first && !(0, postcss_selector_parser_1.isCombinator)(selector.first) && selector.first.value !== ' ';
            ...
            selector.insertBefore(selector.first, (0, postcss_selector_parser_1.attribute)({
                attribute: 'dir',
                operator: '=',
                quoteMark: '"',
                value: `"${value}"`,
